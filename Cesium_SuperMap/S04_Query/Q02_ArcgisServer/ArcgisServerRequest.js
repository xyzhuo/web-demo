...
_ArcgisServerRequest.prototype.queryByQuery = function(queryUrl, queryArgs, option = {}) {
    ...
    if (!queryArgs) {
        option.queryQueryFailed("属性查询参数错误为空");
        return;
    }
...
if (typeof module !== "undefined" && typeof module.exports !== "undefined") {
    module.exports.ArcgisServerRequest = ArcgisServerRequest;
} else {
    if (typeof define === "function" && define.amd) {
        define([], function() {
            return ArcgisServerRequest;
        });
    } else {
        window.ArcgisServerRequest = ArcgisServerRequest;
    }
}