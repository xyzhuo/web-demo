 ...
 * }
 */
function queryByArcgisIdentify(queryUrl, geometry, option = {}) {
    ...
    jqueryAjaxGet(queryUrl, {
        data: defaultArgs,
        onQueryComplete: result => {
            option.onQueryComplete({results: result.results, queryModel: "ArcGIS-Identify"});
        },
 ...
 * }
 */
function queryByArcgisQuery(queryUrl, queryArgs, option = {}) {
    if (typeof option.onQueryComplete !== "function") {
        option.onQueryComplete = console.log;
    }
    if (typeof option.queryQueryFailed !== "function") {
    ...
    jqueryAjaxGet(queryUrl, {
        data: defaultArgs,
        onQueryComplete: result => {
            option.onQueryComplete({results: result, queryModel: "ArcGIS-Query"});
        },
        queryQueryFailed: option.queryQueryFailed
    });
}
 ...
 * @param option
 */
function jqueryAjaxGet(queryServerUrl, option = {}) {
    if (typeof option.onQueryComplete !== "function") {
        option.onQueryComplete = console.log;
    }
    if (typeof option.queryQueryFailed !== "function") {
